 ...
 */
export declare function runEventLoop(runningCallback?: Function): Promise<unknown>;
/**
...
export declare namespace private_api {
    ...
    function send_mouse_double_click(component: Component, x: number, y: number): void;
